...
- [05: 现有 7 大业务页面平稳迁入与 0 回归验证方案](issues/05-grilling-zero-regression-page-migration.md) — (已解除阻断·待指令开启 Frontier) 围绕现有 7 大业务页面挂载入 NavigationShell、100% 行为 0 回归防线、162 项测试绿灯保持与异常降级核验清单展开契约盘问与测试设计。
